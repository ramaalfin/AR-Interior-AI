          ...
          {!arSupported && (
            <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 flex gap-3">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>
                  You can still view the 3D model and use the photo capture
                  feature below.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <ul className="space-y-1">
                  ...
                  <li>
                    2. Tap or click on your floor or wall to place the product
                  </li>
                  <li>
                    3. Move your phone around to see the product from different
                    angles
                  </li>
                  <li>4. Use pinch gestures to resize the product</li>
                  <li>
                    5. Click &quot;Take Photo&quot; to capture and download your
                    design
                  </li>
                </ul>
              </div>
