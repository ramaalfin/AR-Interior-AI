...
export default function AnalysisPage() {
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-background to-card">
        <div className="mx-auto max-w-4xl px-4 py-12 text-center">
          <p className="text-muted-foreground">Unable to load analysis. Please try again.</p>
          <Link href="/">
  ...
  const categoriesForUrl = encodeURIComponent(JSON.stringify(analysis.categories));
